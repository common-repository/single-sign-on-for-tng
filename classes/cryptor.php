...
class SSOFORTNG_cryptor {
    ...
    static private $salt        = '!sr%wsk9WLh!%$CQ6Dec';       # change
    static private $hashlength  = 32;           # change between 10 and 64 (64 = length of sodium_crypto_generichash)
